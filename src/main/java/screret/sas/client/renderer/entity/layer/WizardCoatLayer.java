...
public class WizardCoatLayer extends GeoLayerRenderer<WizardMob> {
    ...
    public WizardCoatLayer(IGeoRenderer<WizardMob> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, WizardMob entityLivingBaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
