...
public class WizardModel extends AnimatedGeoModel<WizardMob> {
    ...
    @Override
    public ResourceLocation getModelResource(WizardMob object) {
        return MODEL_RESOURCE;
    }

    @Override
    public ResourceLocation getTextureResource(WizardMob object) {
        return TEXTURE_RESOURCE;
    }

    @Override
    public ResourceLocation getAnimationResource(WizardMob animatable) {
