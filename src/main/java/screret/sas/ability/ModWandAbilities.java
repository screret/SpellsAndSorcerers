...
public class ModWandAbilities {
    ...
    public static final RegistryObject<WandAbility> SHOOT_HOLD_DOWN = WAND_ABILITIES.register("shoot_hold_down", () -> new ShootAbility(20, 20, 1, true, 16, ParticleTypes.HAPPY_VILLAGER, Vec3.ZERO));
    ...
    public static final RegistryObject<WandAbility> SMALL_FIREBALL = WAND_ABILITIES.register("small_fireball", SmallFireballAbility::new); //new ProjectileAbility(0, 20, 0, true, 512, SmallFireball.class, EntityType.SMALL_FIREBALL));
