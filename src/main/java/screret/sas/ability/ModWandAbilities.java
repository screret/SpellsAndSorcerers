...
public class ModWandAbilities {
    ...
    public static final RegistryObject<WandAbility> SHOOT_HOLD_DOWN = WAND_ABILITIES.register("shoot_hold_down", () -> new ShootAbility(20, 20, 0, true, 16, ParticleTypes.HAPPY_VILLAGER, Vec3.ZERO, 0xFF00ae2d));
    public static final RegistryObject<WandAbility> SHOOT_ANGRY_RAY = WAND_ABILITIES.register("shoot_angry_ray", () -> new ShootAbility(100, 200, 0, true, 8, ExplodeAbility.PARTICLE, ExplodeAbility.RANDOM_DEVIATION, 0xFFAA0000));
    public static final RegistryObject<WandAbility> SHOOT_LIGHTNING = WAND_ABILITIES.register("shoot_lightning", () -> new ShootAbility(0, 25, 0, true, 32, ParticleTypes.ELECTRIC_SPARK, Vec3.ZERO, 0xFFAAAAAA));
    ...
    public static final RegistryObject<WandAbility> LIGHTNING = WAND_ABILITIES.register("lightning", LightningAbility::new);
